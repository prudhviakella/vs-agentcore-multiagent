...
_LOG_GROUP = os.environ.get("LOG_GROUP_NAME", "/agentcore/vs-agentcore-ma/safety-agent")
...
try:
    _rt_id   = os.environ.get("AGENT_RUNTIME_ID", "vs_agentcore_ma_safety-3BSTbuGcFt")
